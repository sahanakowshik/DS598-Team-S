...
class LuxDataset(Dataset):
    ...
    def __getitem__(self, idx) -> DatasetOutput:
        ...
        action_array = np.ones((self.map_size, self.map_size)).astype(np.longlong) * UnitAction.MOVE_CENTER
        ...
        city_action_array = np.ones((self.map_size, self.map_size)).astype(np.longlong) * CitytileAction.DO_NOTHING
